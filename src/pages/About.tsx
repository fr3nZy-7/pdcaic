...
const About = () => {
  const AboutHeroData = {
    ...
    shortDescription:
      "Dedicated to providing exceptional dental care with a personal touch. Our experienced team combines advanced technology with compassionate care to deliver the best possible outcomes for our patients.",
  ...
  const values = [
    {
      ...
      description:
        "We put our patients first, ensuring comfort and satisfaction in every treatment.",
      icon: <Heart className="h-6 w-6" />,
    },
    {
      title: "Excellence in Treatment",
      description:
        "We maintain the highest standards of dental care using advanced technology.",
    ...
    },
    {
      ...
      description:
        "Our team stays updated with the latest dental techniques and technologies.",
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-shade">
              Our Story
            </h2>
            <div className="prose prose-lg mx-auto text-black/80">
              <p className="mb-6">
                Founded with a vision to transform dental care in Lohegaon,
                Pune, Padmanaabh Dental Clinic has been serving the community
                for over 15 years. What started as a small practice has grown
                into a comprehensive dental center, trusted by thousands of
                patients across Pune and surrounding areas.
              </p>
              <p className="mb-6">
                Our commitment to excellence, combined with state-of-the-art
                technology and a patient-first approach, has made us one of the
                most trusted dental clinics in the region. We believe that
                everyone deserves access to quality dental care in a
                comfortable, welcoming environment.
              </p>
              <p>
                Today, we continue to expand our services and expertise, always
                staying at the forefront of dental innovation while maintaining
                the personal touch that our patients have come to expect and
                appreciate.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-black/80 max-w-3xl mx-auto">
              Years of dedication and commitment to excellence have earned us
              the trust and recognition of our community.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-50 to-pink-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-black/80 max-w-3xl mx-auto">
              Meet our experienced and dedicated dental professionals who are
              committed to providing you with the highest quality care.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-y-16 md:flex md:justify-center md:gap-x-8 md:items-start">
            {teamMembers.map((member, index) => (
              <GlassmorphismCard
                key={index}
                className={`p-8 text-center bg-primary/40 backdrop-blur-2xl shadow-lg hover:scale-105 transition-transform
                  ${
                    member.name === "Dr. Neha Deshpande Tambe"
                      ? "md:order-2 md:scale-110 md:z-10"
                      : index === 1
                      ? "md:order-1"
                      : "md:order-3"
                  }
